 ...
 */
const server = {
  host: '116.85.27.153',  //主机ip
  port: 22,                //SSH 连接端口
  username: 'root',        //用户名
  password: 's.111213',     //用户登录密码
}
const baseDir = 'blog'//项目目录
const basePath = '/home/projects'//项目部署目录
const bakDirName = baseDir + '.bak' + moment(new Date()).format('YYYY-M-D-HH:mm:ss')//备份文件名
const buildPath = path.resolve('./docs/.vuepress/dist')//本地项目编译后的文件目录
/*********************************************************************************/
/**********************************配置结束***************************************/
/*********************************************************************************/
